      ...
      <table id="dt-basic" class="table table-striped table-bordered" width="100%">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a class="btn btn-sm btn-warning" href="<?php echo base_url('index.php/Blog/update_view/'.$d['user_id']) ?>"><i class="glyphicon glyphicon-pencil"></i> Edit </a>
              <a class="btn btn-sm btn-danger" href="<?php echo base_url('index.php/Blog/delete_action/'.$d['user_id']) ?>"><i class="glyphicon glyphicon-trash"></i> Delete </a></td>
            </tr>
            <?php endforeach; ?>
            <?php endif; ?>
          </tbody>
